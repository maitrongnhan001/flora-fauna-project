                    ...
                    <div className='body'>
                        <form onSubmit={this.handleSubmit} encType='multipart/form-data'>
                            ...
                            <div className='col-elm'>
                                <div className='elm elm-files'>
                                    ...
                                    <div className='upload-file text-center'>
                                        <label htmlFor='img-product'>Choose image</label>
                                        <input type='file' name='file' id='img-product' onChange={this.handleChangeFile} />
                                    </div>
                            ...
                            <div className='elm elm-col'>
                                ...
                                <input type='button' className='btn btn-primary format-btn-right' value='Cancel' onClick={this.onHideAddFoodForm} />
                            </div>
                        </form>
                    </div>
                </div>
